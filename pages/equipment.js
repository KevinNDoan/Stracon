                ...
                <div className="grid grid-cols-1 md:grid-cols-2 space-x-4">
                    <section className="p-8">
                        <div className="flex justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="8em" height="8em" fill="currentColor" class="bi bi-plug" viewBox="0 0 16 16">
                    ...
                    <section className="p-8">
                        <div className="flex justify-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="8em" height="8em" fill="currentColor" class="bi bi-motherboard" viewBox="0 0 16 16">
