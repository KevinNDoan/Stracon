        ...
        <main>
          ...
          <section className="bg-black w-100 p-20">
            <div className="flex justify-center">
              <div>
                <h1 className="text-white text-4xl md:text-6xl font-bold">AS9100D and</h1>
          ...
          <section className="p-5 md:p-20">
            <div className="text-center md:text-left"><h1 className="text-4xl md:text-6xl font-bold">Get to know Stracon</h1></div>
            <br />
