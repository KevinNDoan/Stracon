    ...
    return (
        <>
            ...
            <main className="m-8 md:m-20">
                <h1 className="text-3xl sm:text-5xl font-bold">We serve the needs of these industries...</h1>
                <br />
                <section className="grid grid-cols-1 lg:grid-cols-2 mb-12 text-3xl md:text-4xl font-bold">
                    <div className={`${styles.box} bg-zinc-100 m-3 md:m-8 p-3 md:p-8`}>
                        <div className="h-20 max-h-20"><h1>Consumer Electronics</h1></div>
                        <div className="h-80 max-h-80 flex justify-center items-center">
                    ...
                    <div className={`${styles.box} bg-zinc-100 m-3 md:m-8 p-3 md:p-8`}>
                        <div className="h-20 max-h-20"><h1>Automotive</h1></div>
                        <div className="h-80 max-h-80 flex justify-center items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="70%" height="70%" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <div className={`${styles.box} bg-zinc-100 m-3 md:m-8 p-3 md:p-8`}>
                        <div className="h-20 max-h-20"><h1>Military/Defense</h1></div>
                        <div className="h-80 max-h-80 flex justify-center items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="70%" height="70%" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <div className={`${styles.box} bg-zinc-100 m-3 md:m-8 p-3 md:p-8`}>
                        <div className="h-20 max-h-20"><h1>Communications</h1></div>
                        <div className="h-80 max-h-80 flex justify-center items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="70%" height="70%" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <div className={`${styles.box} bg-zinc-100 m-3 md:m-8 p-3 md:p-8 `}>
                        <div className="h-20 max-h-20"><h1>Aerospace</h1></div>
                        <div className="h-80 max-h-80 flex justify-center items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="70%" height="70%" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <div className={`${styles.box} bg-zinc-100 m-3 md:m-8 p-3 md:p-8`}>
                        <div className="h-20 max-h-20"><h1>Security Access</h1></div>
                        <div className="h-80 max-h-80 flex justify-center items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="70%" height="70%" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <div className={`${styles.box} bg-zinc-100 m-3 md:m-8 p-3 md:p-8`}>
                        <div className="h-20 max-h-20"><h1>Medicine</h1></div>
                        <div className="h-80 max-h-80 flex justify-center items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="70%" height="70%" fill="currentColor" viewBox="0 0 16 16">
                    ...
                    <div className={`${styles.box} bg-zinc-100 m-3 md:m-8 p-3 md:p-8`}>
                        <div className="h-20 max-h-20"><h1>RF Wireless</h1></div>
                        <div className="h-80 max-h-80 flex justify-center items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" width="70%" height="70%" fill="currentColor" viewBox="0 0 16 16">
